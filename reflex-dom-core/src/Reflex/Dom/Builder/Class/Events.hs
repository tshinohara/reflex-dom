...
data EventName :: EventTag -> * where
  ...
  Compositionstart :: EventName 'CompositionstartTag
  Compositionupdate :: EventName 'CompositionupdateTag
  Compositionend :: EventName 'CompositionendTag
...
type family EventResultType (en :: EventTag) :: * where
  ...
  EventResultType 'CompositionstartTag = ()
  EventResultType 'CompositionupdateTag = String
  EventResultType 'CompositionendTag = String
...
instance GEq EventName
    where geq Abort Abort                         = return Refl
          ...
          geq Compositionstart Compositionstart   = return Refl
          geq Compositionupdate Compositionupdate = return Refl
          geq Compositionend Compositionend       = return Refl
...
instance GCompare EventName
    where gcompare Abort Abort                         = GEQ
          ...
          gcompare Compositionstart Compositionstart   = GEQ
          gcompare Compositionstart _                  = GLT
          gcompare _ Compositionstart                  = GGT
          gcompare Compositionupdate Compositionupdate = GEQ
          gcompare Compositionupdate _                 = GLT
          gcompare _ Compositionupdate                 = GGT
          gcompare Compositionend Compositionend       = GEQ
          gcompare Compositionend _                    = GLT
          gcompare _ Compositionend                    = GGT
